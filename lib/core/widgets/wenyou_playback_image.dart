...
class WenyouPlaybackImage extends StatefulWidget {
  const WenyouPlaybackImage({
  ...
  @override
  State<WenyouPlaybackImage> createState() => _WenyouPlaybackImageState();
}

class _WenyouPlaybackImageState extends State<WenyouPlaybackImage> {
  bool _failed = false;
  ...
  @override
  void didUpdateWidget(covariant WenyouPlaybackImage oldWidget) {
