...
class _WenyouMaterialApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final appearance = ref.watch(appearancePreferenceControllerProvider);
    return MaterialApp.router(
      title: '温油站',
      debugShowCheckedModeBanner: false,
      theme: AppTheme.light,
      darkTheme: AppTheme.dark,
      themeMode: appearance.preference.themeMode,
      themeAnimationDuration: WenyouFoundationMotion.standard,
