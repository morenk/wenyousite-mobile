...
- 后端契约：`4.13.1-dev.20260815.1`，revision `221e28cd0e25cedb2ad1c7c4c1568175e0c3c9c6`。
...
4. 接入用户主页背景图与活动汇总；在公开资料和本人编辑流程中补齐加载、权限、上传与失效状态。
5. 在可信管理员角色投影、高风险确认和刷新策略具备后，接入普通 Bearer 内容隐藏能力；此前不展示入口。
6. 使用公网专用账号补齐各模块文档中尚未勾选的手工联调与真机验收，禁止对共享开发数据执行破坏性批量操作。
