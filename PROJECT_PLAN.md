...
新增反馈：引用长文本溢出候选，**待负责人验收**。已按手机汇总候选及“浮陆之国”精确原文复现；原问题的 9 项布局／真实主题页检查在旧实现失败、候选通过。候选保留既有分页和删除调整，版本及复验步骤见 [引用溢出验收](docs/architecture/quote-text-overflow-acceptance.md)。
