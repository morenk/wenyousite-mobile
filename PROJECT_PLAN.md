...
- 后端契约：`5.26.0-dev.20260922.3`，来源 `92b030a81f8957386e324fed477bd1e46faf65ea`；生成客户端已同步图集查询、本人关系列表管理和仅供管理端使用的内容整理接口。图集连续浏览与本人关系管理候选已进入 `dev`，图集正文定位、权限和真机手势仍待负责人复验。
