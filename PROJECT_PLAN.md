...
- 2026-09-11 契约同步：本任务分支已同步后端 `0ee2c0de1d9c570e495e778be6661b074b7a4bef` 的 `5.20.0-dev.20260909.1`，生成客户端增加可空封面媒体与动画预览字段，暂不接入播放。公网只读核对为 `5.18.0-dev.20260905.1` / `6bfb818df4ccf5333df7b62018a9f519d91e935b`，线上版本对齐待后端任务完成；下列旧契约条目保留此前交付背景。
