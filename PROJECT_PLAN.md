...
- 后端契约：`5.18.0-dev.20260905.1`，候选来源 `3338028459561565c788d5236fb64db84a2ae538`；本轮同步 newline v1 revision 2 的手动回车对齐规则，HTTP SDK 与其他语料不变。该来源尚未部署，公网 `/meta` 实测仍为 `e8d0fd6cb193ab5e9a1c2c51c03382ef300adc0c`；移动端适配与跨端效果仍待验收。签到经验、主题帖档案导出、子贴主楼层置顶、Markdown v5、编辑器往返 v7、剪贴板 v2 与独立图片块对齐保持原能力。
