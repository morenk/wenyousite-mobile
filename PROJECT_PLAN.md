...
- 后端契约：`5.18.0-dev.20260905.1`，revision `6b0c9c83ecd4532490cf07ad38eff9e10eb277b3`；签到返回当天实际发放经验（0～2），内容互动经验由后端异步幂等结算；主题帖档案导出、子贴主楼层置顶、Markdown v5、编辑器往返黄金契约 v7、剪贴板契约 v2 与独立图片块对齐保持激活，公网 `/meta` 已核对为 `5.18.0-dev.20260905.1` / `6b0c9c8`，契约同步锁定实际部署提交，纯文档分支头不作为部署来源。
