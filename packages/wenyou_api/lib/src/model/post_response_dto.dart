...
abstract class PostResponseDto implements Built<PostResponseDto, PostResponseDtoBuilder> {
  ...
  PostResponseDtoKindEnum get kind;
...
class _$PostResponseDtoSerializer implements PrimitiveSerializer<PostResponseDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.kind,
      specifiedType: const FullType(PostResponseDtoKindEnum),
    );
    yield r'floorNumber';
...
class PostResponseDtoKindEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'BODY')
  static const PostResponseDtoKindEnum BODY = _$postResponseDtoKindEnum_BODY;
  @BuiltValueEnumConst(wireName: r'FLOOR')
  static const PostResponseDtoKindEnum FLOOR = _$postResponseDtoKindEnum_FLOOR;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PostResponseDtoKindEnum unknownDefaultOpenApi = _$postResponseDtoKindEnum_unknownDefaultOpenApi;

  static Serializer<PostResponseDtoKindEnum> get serializer => _$postResponseDtoKindEnumSerializer;

  const PostResponseDtoKindEnum._(String name): super(name);

  static BuiltSet<PostResponseDtoKindEnum> get values => _$postResponseDtoKindEnumValues;
  static PostResponseDtoKindEnum valueOf(String name) => _$postResponseDtoKindEnumValueOf(name);
}
