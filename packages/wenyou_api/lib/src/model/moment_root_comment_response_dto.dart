...
part 'moment_root_comment_response_dto.g.dart';
...
abstract class MomentRootCommentResponseDto implements Built<MomentRootCommentResponseDto, MomentRootCommentResponseDtoBuilder> {
  ...
  MomentRootCommentResponseDto._();

  factory MomentRootCommentResponseDto([void updates(MomentRootCommentResponseDtoBuilder b)]) = _$MomentRootCommentResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MomentRootCommentResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MomentRootCommentResponseDto> get serializer => _$MomentRootCommentResponseDtoSerializer();
}

class _$MomentRootCommentResponseDtoSerializer implements PrimitiveSerializer<MomentRootCommentResponseDto> {
  @override
  final Iterable<Type> types = const [MomentRootCommentResponseDto, _$MomentRootCommentResponseDto];

  @override
  final String wireName = r'MomentRootCommentResponseDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MomentRootCommentResponseDto object, {
  ...
  void _deserializeProperties(
    ...
    required MomentRootCommentResponseDtoBuilder result,
  ...
  @override
  MomentRootCommentResponseDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MomentRootCommentResponseDtoBuilder();
