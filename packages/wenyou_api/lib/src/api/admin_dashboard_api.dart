...
class AdminDashboardApi {
  ...
  Future<Response<AdminDashboardDistributions200Response>> adminDashboardDistributions({
    ...
    final _path = r'/api/v1/admin/dashboard/distributions';
    ...
    AdminDashboardDistributions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminDashboardDistributions200Response),
      ) as AdminDashboardDistributions200Response;
    ...
    return Response<AdminDashboardDistributions200Response>(
      data: _responseData,
  ...
  Future<Response<AdminDashboardOverview200Response>> adminDashboardOverview({
    ...
    final _path = r'/api/v1/admin/dashboard/overview';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xCSRFToken != null) r'X-CSRF-Token': xCSRFToken,
    ...
    AdminDashboardOverview200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminDashboardOverview200Response),
      ) as AdminDashboardOverview200Response;
    ...
    return Response<AdminDashboardOverview200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminDashboardTimeseries200Response>> adminDashboardTimeseries({
    ...
    final _path = r'/api/v1/admin/dashboard/timeseries';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xCSRFToken != null) r'X-CSRF-Token': xCSRFToken,
    ...
    AdminDashboardTimeseries200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminDashboardTimeseries200Response),
      ) as AdminDashboardTimeseries200Response;
    ...
    return Response<AdminDashboardTimeseries200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
