...
class DraftsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DraftsCreate201Response] as data
  ...
  Future<Response<DraftsCreate201Response>> draftsCreate({
    ...
    try {
      const _type = FullType(CreateDraftDto);
      _bodyData = _serializers.serialize(createDraftDto, specifiedType: _type);
    ...
    DraftsCreate201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DraftsCreate201Response),
      ) as DraftsCreate201Response;
    ...
    return Response<DraftsCreate201Response>(
      data: _responseData,
  ...
  Future<Response<DraftsFindAll200Response>> draftsFindAll({
    ...
    DraftsFindAll200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DraftsFindAll200Response),
      ) as DraftsFindAll200Response;
    ...
    return Response<DraftsFindAll200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DraftsFindById200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DraftsFindById200Response>> draftsFindById({
    ...
    final _path = r'/api/v1/drafts/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DraftsFindById200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DraftsFindById200Response),
      ) as DraftsFindById200Response;
    ...
    return Response<DraftsFindById200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DraftsRemove200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DraftsRemove200Response>> draftsRemove({
    ...
    DraftsRemove200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DraftsRemove200Response),
      ) as DraftsRemove200Response;
    ...
    return Response<DraftsRemove200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<DraftsSlotUsage200Response>> draftsSlotUsage({
    ...
    final _path = r'/api/v1/drafts/slots';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DraftsSlotUsage200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DraftsSlotUsage200Response),
      ) as DraftsSlotUsage200Response;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DraftsUpdate200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DraftsUpdate200Response>> draftsUpdate({
    ...
    try {
      const _type = FullType(UpdateDraftDto);
      _bodyData = _serializers.serialize(updateDraftDto, specifiedType: _type);
    ...
    DraftsUpdate200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DraftsUpdate200Response),
      ) as DraftsUpdate200Response;
    ...
    return Response<DraftsUpdate200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
