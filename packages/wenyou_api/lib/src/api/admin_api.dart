...
class AdminApi {
  ...
  Future<Response<AdminGetHistory200Response>> adminGetHistory({
    ...
    final _path = r'/api/v1/admin/notifications/system/history';
    ...
    AdminGetHistory200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminGetHistory200Response),
      ) as AdminGetHistory200Response;
    ...
    return Response<AdminGetHistory200Response>(
      data: _responseData,
  ...
  Future<Response<AdminIndex200Response>> adminIndex({
    ...
    AdminIndex200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminIndex200Response),
      ) as AdminIndex200Response;
    ...
    return Response<AdminIndex200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminPreviewRecipients201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminPreviewRecipients201Response>> adminPreviewRecipients({
    ...
    final _path = r'/api/v1/admin/notifications/system/preview';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xCSRFToken != null) r'X-CSRF-Token': xCSRFToken,
    ...
    try {
      const _type = FullType(SendSystemNotificationDto);
      _bodyData = _serializers.serialize(sendSystemNotificationDto, specifiedType: _type);
    ...
    AdminPreviewRecipients201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminPreviewRecipients201Response),
      ) as AdminPreviewRecipients201Response;
    ...
    return Response<AdminPreviewRecipients201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminSearchUsers200Response>> adminSearchUsers({
    ...
    final _path = r'/api/v1/admin/users/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xCSRFToken != null) r'X-CSRF-Token': xCSRFToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminSendSystemNotification201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminSendSystemNotification201Response>> adminSendSystemNotification({
    ...
    final _path = r'/api/v1/admin/notifications/system';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xCSRFToken != null) r'X-CSRF-Token': xCSRFToken,
    ...
    AdminSendSystemNotification201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminSendSystemNotification201Response),
      ) as AdminSendSystemNotification201Response;
    ...
    return Response<AdminSendSystemNotification201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
