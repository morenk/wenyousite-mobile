...
class ReportsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ReportsCreate201Response] as data
  ...
  Future<Response<ReportsCreate201Response>> reportsCreate({
    ...
    ReportsCreate201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ReportsCreate201Response),
      ) as ReportsCreate201Response;
