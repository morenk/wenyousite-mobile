...
class AuthApi {
  ...
  Future<Response<AuthListSessions200Response>> authListSessions({
    ...
    AuthListSessions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthListSessions200Response),
      ) as AuthListSessions200Response;
    ...
    return Response<AuthListSessions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthRequestChangeEmailCode200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRequestChangeEmailCode200Response>> authRequestChangeEmailCode({
    ...
    final _path = r'/api/v1/auth/change-email/request-code';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ChangeEmailRequestDto);
      _bodyData = _serializers.serialize(changeEmailRequestDto, specifiedType: _type);
    ...
    AuthRequestChangeEmailCode200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthRequestChangeEmailCode200Response),
      ) as AuthRequestChangeEmailCode200Response;
    ...
    return Response<AuthRequestChangeEmailCode200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthRequestCode200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRequestCode200Response>> authRequestCode({
    ...
    final _path = r'/api/v1/auth/register/request-code';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestCodeDto);
      _bodyData = _serializers.serialize(requestCodeDto, specifiedType: _type);
    ...
    AuthRequestCode200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthRequestCode200Response),
      ) as AuthRequestCode200Response;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthRevokeSession200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRevokeSession200Response>> authRevokeSession({
    ...
    final _path = r'/api/v1/auth/sessions/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AuthRevokeSession200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthRevokeSession200Response),
      ) as AuthRevokeSession200Response;
    ...
    return Response<AuthRevokeSession200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthVerifyAndComplete200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthVerifyAndComplete200Response>> authVerifyAndComplete({
    ...
    final _path = r'/api/v1/auth/register/verify-and-complete';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xClientPlatform != null) r'X-Client-Platform': xClientPlatform,
    ...
    try {
      const _type = FullType(VerifyAndCompleteDto);
      _bodyData = _serializers.serialize(verifyAndCompleteDto, specifiedType: _type);
    ...
    AuthVerifyAndComplete200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthVerifyAndComplete200Response),
      ) as AuthVerifyAndComplete200Response;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthVerifyChangeEmail200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthVerifyChangeEmail200Response>> authVerifyChangeEmail({
    ...
    final _path = r'/api/v1/auth/change-email/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ChangeEmailVerifyDto);
      _bodyData = _serializers.serialize(changeEmailVerifyDto, specifiedType: _type);
    ...
    AuthVerifyChangeEmail200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthVerifyChangeEmail200Response),
      ) as AuthVerifyChangeEmail200Response;
