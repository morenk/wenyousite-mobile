...
V1 包含认证、公开浏览、搜索、主题/子贴/楼层、创作管理、图片、提及、骰子、草稿、收藏、关注、订阅、拉黑、账号设置、站内通知和站内私聊。

V1 暂不实现：收藏表情、FCM 系统推送、举报/管理后台、离线阅读、离线自动发帖、暗色主题、阅读进度、子贴标签和 Android App Links。
...
- `0.4.0-dev`：回复、点赞、收藏、关注、订阅、拉黑、通知和站内私聊。
