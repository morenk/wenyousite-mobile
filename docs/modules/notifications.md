...
升级通知由后端经验结算产生，继续映射 `level_up` 并展示服务端安全文案；不因签到、发帖或加油成功在本地生成第二份升级通知。无内容目标的升级通知仅支持阅读与已读管理，不伪造主题跳转。
...
契约 `5.16.0-dev.20260904.1`；Markdown v5；后端 `fb02efa2ea4f4fd8f9b793f6d4bbd9f9f74a2d7e`；Foundation `v6.8.0`（`a9318b8`）。
