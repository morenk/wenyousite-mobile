...
选择控件修缮候选（2026-09-19，待负责人验收）：排序和状态使用按内容收缩的安静文字入口，展开态共享轻量选择菜单：Foundation 面板、细边界、右侧勾选与选中底色，长文字自然换行，触控区不少于 48dp。 验收清单见[选择控件修缮](../architecture/selection-controls-acceptance.md)。
