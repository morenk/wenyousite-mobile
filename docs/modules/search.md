...
2026-09-11 已复核并同步契约 `5.20.0-dev.20260909.1`，后端 `0ee2c0de1d9c570e495e778be6661b074b7a4bef`。生成客户端增加可空 `coverMedia` 和 `previewVariants`；本模块继续消费原 `coverImages`，动画预览接入由独立切片负责。以下保留此前行为验收来源。
