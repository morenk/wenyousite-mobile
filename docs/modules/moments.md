...
契约 `4.7.0-dev.20260811.1`；Markdown v2（动态正文不消费）；后端 `143618951b0746b049f9d6ac9718b35e4139847d`；Foundation `v1.2.0`（`4cce5e2ab0ac1a8c328a24673a568ad5de9d9606`）。
