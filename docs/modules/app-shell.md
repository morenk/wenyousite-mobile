...
契约 `5.20.1-dev.20260911.1`；公网 Markdown v5、客户端兼容 `{3, 4, 5}`；后端 `b785336c5b31cb228f3021650b9de1c39ade02e5`；Foundation `v6.9.0`（`5888132`）。签到经验遵循实际 `experienceAwarded`，日活奖励可能已由其他有效行为领取。
