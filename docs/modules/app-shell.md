...
契约 `5.20.0-dev.20260909.1`；公网 Markdown v5、客户端兼容 `{3, 4, 5}`；后端 `0ee2c0de1d9c570e495e778be6661b074b7a4bef`；Foundation `v6.9.0`（`5888132`）。签到经验遵循实际 `experienceAwarded`，日活奖励可能已由其他有效行为领取。
