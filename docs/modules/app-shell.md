...
组件统一第一批（2026-09-19，候选／待负责人验收）：消息中心“全部已读”和收藏夹新建入口改用共享异步操作组件，保留原通知及目录状态；处理中不能重复触发。 入口清单、自动检查及真机步骤见[组件统一验收](../architecture/component-consistency-acceptance.md)。
