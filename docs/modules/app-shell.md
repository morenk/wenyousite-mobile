...
契约 `5.16.0-dev.20260904.1`；公网 Markdown v5、客户端兼容 `{3, 4, 5}`；后端 `fb02efa2ea4f4fd8f9b793f6d4bbd9f9f74a2d7e`；Foundation `v6.8.0`（`196deaf`）。签到经验遵循实际 `experienceAwarded`，日活奖励可能已由其他有效行为领取。
