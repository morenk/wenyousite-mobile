...
契约 `5.21.0-dev.20260911.1`；公网 Markdown v5、客户端兼容 `{3, 4, 5}`；后端 `88ad7be52722c2fa2810515badd2a2ec4d2d2cfd`；Foundation `v6.9.0`（`5888132`）。签到经验遵循实际 `experienceAwarded`，日活奖励可能已由其他有效行为领取。
