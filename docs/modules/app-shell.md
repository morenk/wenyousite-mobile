...
契约 `5.17.0-dev.20260905.2`；公网 Markdown v5、客户端兼容 `{3, 4, 5}`；后端 `80e9820b06d3f7cbea209e11d2b7be5353add0a5`；Foundation `v6.8.0`（`196deaf`）。签到经验遵循实际 `experienceAwarded`，日活奖励可能已由其他有效行为领取。
