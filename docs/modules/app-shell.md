...
图片上传切片契约复核：Backend `fc88ea09a808af9c54c1f5b971e116b3be4a471b` / OpenAPI `5.24.0-dev.20260920.1`，与已核验公网 `/meta` 一致。新增三个管理端点不属于移动端 V1；本轮使用的媒体上传、确认、查询与 Markdown 契约保持不变。
