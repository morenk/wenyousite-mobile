...
- 兼容后端已先行合并与部署，消费端仍待负责人验收与发布；本候选来源已同步 Backend `92b030a81f8957386e324fed477bd1e46faf65ea` / `5.26.0-dev.20260922.3`（关系接口与此前 4850e2f 来源完全一致）。旧后端不能提供新管理能力，但原列表仍可读取；不逐行请求主页补投影。
