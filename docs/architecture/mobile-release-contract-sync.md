...
2026-09-27 在 Windows 独立任务分支同步 Backend 已提交候选 `99b42dc0f7d25eeb6e49ee87441e206c77cce29a`，契约 `5.27.0-dev.20260927.1`。来源分支为 `origin/codex/20260927-mobile-release-notes`；标准同步脚本显式传入该分支与完整 revision，只读取后端镜像的已提交 Git 对象。
...
这是候选契约同步，不代表后端部署或端到端验收。公开 `/meta` 仍为 `124fb4e8aa395440f7a2156de98b642ec87f7583`、`5.26.0-dev.20260922.3`，最终门禁须保留该差异的失败结果。Windows 受限发布 CLI 将按 Backend 后续精确提交独立交接。
